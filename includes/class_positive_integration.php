...
class OEPS_PositiveIntegration {
    ...
    public static function getStockProduct( $html ) {
        global $product;
        $positiveController = OEPS_PositiveAPIComunication::getInstance( );
        $positiveProduct = $positiveController->getProductById( $product->get_id() );
    ...
    public static function pullData( ) {
        // $positiveProducts = OEPS_PositiveAPIComunication::getProducts( );
